...
import com.jh.testfragment.demo_flow.MainActivity;
...
public class EnterActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        findViewById(R.id.btn_wechat).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(EnterActivity.this, com.jh.testfragment.demo_wechat.MainActivity.class));
            }
        });
        ...
        findViewById(R.id.btn_zhihu).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(EnterActivity.this, com.jh.testfragment.demo_zhihu.MainActivity.class));
            }
        });
    }
}
