package com.jh.zhihuui.fragment.first;
...
import com.jh.zhihuui.adapter.FirstHomeAdapter;
import com.jh.zhihuui.demo.zhihu.ZhiHuActivity;
import com.jh.zhihuui.event.TabSelectedEvent;
import com.jh.zhihuui.fragment.helper.DetailTransition;
import com.jh.zhihuui.listener.OnItemClickListener;
import com.jh.zhihuui.model.Article;
...
public class FirstHomeFragment extends SupportFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public void onTabSelectedEvent(TabSelectedEvent event) {
        if (event.position != ZhiHuActivity.FIRST) return;
